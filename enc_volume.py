...
def main(argv):
    ...
    parser.add_argument('-key_id', '--aws_access_key_id',
        help='AWS Access Key ID to use', required=False)
    parser.add_argument('-secret_key', '--aws_secret_access_key',
        help='AWS Secret Access Key to use', required=False)
